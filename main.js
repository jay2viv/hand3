 ...
 function save_image()
{
    Webcam.snap( function(data_uri){
        ...
        document.getElementById('picture').innerHTML = 
         '<img id = "pic_1" src="'+data_uri+'"/>';
    });
}

classifier = ml5.imageClassifier("https://teachablemachine.withgoogle.com/models/OxeUZO1xi/model.json",modelReady);

function check()
{
    image1 = document.getElementById("pic_1");
